...
func NewStartScriptCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			execution, err := client.ExecuteScript(scriptID, namespace, name, params, executorArgs)
	...
	cmd.Flags().StringArrayVar(&executorArgs, "args", []string{}, "execution envs passed to executor")
